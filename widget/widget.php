<?php
	...
	// Constructor //
		...
		function __construct() {
			...
			parent::__construct( 'store_widget', 'TT Store', $widget_ops, $control_ops ); // Create the widget
		}
	...
	// Widget Control Panel //
		...
		<p>
			<label for="<?php echo $this->get_field_id('TT_number'); ?>"><?php _e('Which store would you like to show:', 'tradetracker-store'); ?></label>
		...
		<?php _e('Make sure this store will only show one item. Either by limiting the amount of items <a href="admin.php?page=tt-store&option=store">here</a> or by only selecting one item <a href="admin.php?page=tt-store&option=itemselect">here</a>','tradetracker-store'); ?>
