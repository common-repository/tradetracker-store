...
<div id="TB_window1" style="left: auto;margin-left: auto;margin-right: auto; margin-top: 0;right: auto;top: 48px;visibility: visible;z-index:100051;width: <?php echo esc_attr($adminwidth); ?>px;">
	...
	<?php echo $ttstorehidden; ?>
		<div id="TB_title">
			<div id="TB_ajaxWindowTitle"><?php _e('Search Settings.', 'tradetracker-store'); ?></div>
	...
	<tr>
		<td>
			<label for="tradetrackerwidth" title="<?php _e('Use the same settings as used for this store.', 'tradetracker-store'); ?>" class="info">
				<?php _e("Use same setting as this Store:", 'tradetracker-store' ); ?>
			</label> 
		</td>
		<td>
...
<?php
		...
		$tablelayout = TT_StorePRO_TABLE_PREFIX."multi";
